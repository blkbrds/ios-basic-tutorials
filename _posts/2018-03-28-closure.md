...
- Biểu thức closure là tham số có phần khối lệnh khá dài.
...
Một closure có thể **capture** (nắm giữ) các hằng số và biến từ ngữ cảnh xung quanh lúc nó được định nghĩa. Closure sau đó có thể gán và sửa đổi các giá trị của những hằng số và các biến từ bên trong body của nó, ngay cả khi phạm vi ban đầu mà xác định các hằng số và các biến không còn tồn tại.
